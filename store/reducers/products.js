import { CREATE_PRODUCT, DELETE_PRODUCT, SET_FILTERS, SET_PRODUCTS, TOGGLE_FAVORITE, UPDATE_PRODUCT } from '../actions/products';
    ...
    switch (action.type) {
        ...
        case TOGGLE_FAVORITE:
            ...
            if(prodIndex >= 0) {
                ...
                const favProd = state.availableProducts.find(prod => prod.id === action.pid);
                return{
                    ...state, favoriteProducts: state.favoriteProducts.concat(favProd)
                }
            };
        case SET_FILTERS:
            const appliedFilters = action.filters;
            const updatedFilteredProducts = state.availableProducts.filter(product => {
